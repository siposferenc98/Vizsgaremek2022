<?php
    ...
    $result = CallAPI("GET", "https://localhost:5001/Burgerek/Aktiv" );  // CallAPI hívása, csak az aktív elemeket adja vissza

    $decoded = json_decode($result[1]); // a visszakapott választ json formátummá alakítjuk
    //var_dump($decoded);
